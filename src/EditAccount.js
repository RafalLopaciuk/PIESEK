                ...
                <Grid style={{ height: "100%", padding: 0, margin: 0 }}>
                    ...
                    <Grid.Column stretched width={14}>
                        <div>
                            ...
                            <Grid columns={4}>
                                <Grid.Column>
                                    <p style={{ display: this.state.success ? "block" : "none", color: "green" }}>Udana edycja konta.</p>
                                    <p style={{ display: this.state.error ? "block" : "none", color: "red" }}>Problem z edycją.</p>
                                    ...
                                    <Form style={{ display: this.state.permissons ? "block" : "none" }} onSubmit={this.onSubmit}>
                                        <div style={{ backgroundColor: "#E9E9E9", borderRadius: 15 }} >
                                            ...
                                            <Form.Field style={{ marginRight: 75, marginLeft: 75 }}>
                                                ...
                                                <input value={this.state.lastName} onChange={e => this.setState({ lastName: e.target.value })} placeholder='' />
                                            </Form.Field>
